...
custom_local_manifest = ".repo/local_manifests/storm.xml"
custom_default_revision = "reikon"
custom_dependencies = "stormbreaker.dependencies"
org_manifest = "github/StormBreaker-project"  # leave empty if org is provided in manifest
org_display = "stormbreaker-project"  # needed for displaying
